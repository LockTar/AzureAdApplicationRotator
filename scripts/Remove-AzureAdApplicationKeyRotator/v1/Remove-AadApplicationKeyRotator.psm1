...
function Remove-AadApplicationKeyRotator {
    [CmdletBinding()]
    Param(
        [Parameter(Mandatory)]
    ...
    if ($functionApp) {
        ...
        Remove-AzureRmWebApp -ResourceGroupName $ResourceGroupName -Name $functionAppName -Force -Confirm
    }
    else {
    ...
    if ($appServicePlan) {
        ...
        Remove-AzureRmAppServicePlan -ResourceGroupName $ResourceGroupName -Name $appServicePlanName -Force -Confirm
    }
    else {
    ...
    if ($storageAccount) {
        ...
        Remove-AzureRmStorageAccount -ResourceGroupName $ResourceGroupName -Name $storageAccountName -Force -Confirm
    }
    else {
